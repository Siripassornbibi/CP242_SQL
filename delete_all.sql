drop table "WKSP_PROJECTCP242"."APPLICANT_STAT" cascade constraints;
drop table "WKSP_PROJECTCP242"."COURSE" cascade constraints;
drop table "WKSP_PROJECTCP242"."STATISTIC" cascade constraints;
drop table "WKSP_PROJECTCP242"."SUBJECT" cascade constraints;
