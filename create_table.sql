...
ALTER TABLE FACULTY ADD CONSTRAINT FACULTY_FK FOREIGN KEY (DEPARTMENT_ID)
...
ALTER TABLE FACULTY ADD CONSTRAINT UNIVERSITY_FK FOREIGN KEY (FACULTY_ID,DEPARTMENT_ID)
